...
})({"4Y9UD":[function(require,module,exports) {
...
const cardName = (0, _redomEsJs.el)("span", {
    className: "card__name"
}, "John Doe");
const cardNumber = (0, _redomEsJs.el)("span", {
    className: "card__number"
}, "xxxx xxxx xxxx xxxx");
const cardDate = (0, _redomEsJs.el)("span", {
    className: "card__date"
}, "04/24");
const CardRe = ()=>{
    const creditCard = (0, _redomEsJs.el)("div", {
        className: "credit-card"
    }, cardNumber, (0, _redomEsJs.el)("div", {
    ...
    const inputHolder = (0, _redomEsJs.el)("input", {
    ...
    function holderSubmit() {
        inputHolder.addEventListener("input", ()=>{
            inputHolder.value = inputHolder.value.replace(/[^A-Za-z\s]+$/gi, "").toUpperCase();
            cardName.textContent = inputHolder.value.toUpperCase();
        });
    }
    const inputNumber = (0, _redomEsJs.el)("input", {
    ...
    const inputDate = (0, _redomEsJs.el)("input", {
    ...
    const inputCvv = (0, _redomEsJs.el)("input", {
    ...
    return (0, _redomEsJs.el)("div", {
        className: "wrapper"
    }, card);
};
(0, _redomEsJs.setChildren)(document.body, CardRe());
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"1eY2j"}],"1eY2j":[function(require,module,exports) {
...
},{}]},["4Y9UD","2OpUZ"], "2OpUZ", "parcelRequire94c2")

//# sourceMappingURL=main.6690e0da.js.map
